        ...
        <div className="gsap-dest-grid grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
          ...
          <div className="lg:col-span-6">
            <Link
              ...
              className="gsap-dest-card group relative block w-full h-[440px] sm:h-[500px] lg:h-full min-h-[480px] lg:min-h-[580px] rounded-md overflow-hidden bg-slate-900 shadow-sm transition-all duration-500 hover:-translate-y-1"
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8 z-20 flex flex-col justify-end">
                ...
                <div className="mt-4 pt-3 border-t border-white/20 flex items-center justify-between opacity-0 max-h-0 group-hover:opacity-100 group-hover:max-h-20 transition-all duration-500 overflow-hidden">
                  ...
                  <span className="inline-flex items-center gap-1.5 px-4 py-2 bg-[#ED1B26] hover:bg-[#C4141E] text-white text-xs sm:text-sm font-semibold rounded-md transition-all shadow-md">
          ...
          <div className="lg:col-span-6 flex flex-col gap-6">
            ...
            <Link
              ...
              className="gsap-dest-card group relative block w-full h-[260px] sm:h-[278px] rounded-md overflow-hidden bg-slate-900 shadow-sm transition-all duration-500 hover:-translate-y-1"
            >
              {/* Secondary Hover Image (Layered Underneath) */}
              <Image
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8 z-20">
                ...
                <div className="mt-2 flex items-center justify-between opacity-0 max-h-0 group-hover:opacity-100 group-hover:max-h-16 transition-all duration-500 overflow-hidden">
                  ...
                  <span className="inline-flex items-center gap-1 text-[#ED1B26] bg-white px-3 py-1.5 rounded-md text-xs font-bold shadow-sm">
                    <span>Explore</span>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 flex-1">
              ...
              <Link
                ...
                className="gsap-dest-card group relative block w-full h-[250px] sm:h-[278px] rounded-md overflow-hidden bg-slate-900 shadow-sm transition-all duration-500 hover:-translate-y-1"
              >
                {/* Secondary Hover Image (Layered Underneath) */}
                <Image
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 z-20">
                  ...
                  <div className="mt-2 flex items-center justify-between opacity-0 max-h-0 group-hover:opacity-100 group-hover:max-h-16 transition-all duration-500 overflow-hidden">
                    ...
                    <span className="inline-flex items-center gap-1 text-[#ED1B26] bg-white px-2.5 py-1 rounded-md text-xs font-bold shadow-sm">
                      <span>Explore</span>
                      <ArrowRight className="w-3 h-3" />
                    </span>
                  </div>
