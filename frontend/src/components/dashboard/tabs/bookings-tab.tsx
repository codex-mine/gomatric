...
export function BookingsTab({ role = "ADMIN" }: BookingsTabProps) {
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400 mt-1">
            Review and manage traveler holiday bookings, passenger manifests, and tour reservations.
          </p>
        </div>
      ...
      <EmptyState
        icon={Bookmark}
        badge="Reservations Pipeline"
        title="No Tour Bookings Found"
        description="Confirmed traveler reservations, tour packages, and custom group bookings will appear here once booked."
        action={
          <Link
            href="/tours"
